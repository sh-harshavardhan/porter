"""Model definitions for Connection details : sources/target."""
...
class Connection(BaseModel, ABC):
    """Base model for different types of data sources/target.
    All sources/target should accept this config, any additional parameters can be passed via the `args` field.
    """
